...
namespace EntityFrameworkCore.SqlServer.SimpleBulks.Extensions
{
    public static class DbContextExtensions
    {
        ...
        public static void BulkInsert<T>(this DbContext dbContext, IEnumerable<T> data, string tableName, params string[] columnNames)
        {
        ...
        public static void BulkUpdate<T>(this DbContext dbContext, IEnumerable<T> data, string tableName, string idColumn, params string[] columnNames)
        {
            dbContext.GetSqlConnection().BulkUpdate(data, tableName, idColumn, columnNames);
        }

        public static void BulkUpdate<T>(this DbContext dbContext, IEnumerable<T> data, string tableName, List<string> idColumns, params string[] columnNames)
        {
        ...
        public static void BulkDelete<T>(this DbContext dbContext, IEnumerable<T> data, string tableName, List<string> idColumns)
        {
        ...
        public static void BulkMerge<T>(this DbContext dbContext, IEnumerable<T> data, string tableName, string idColumn, string[] updateColumnNames, string[] insertColumnNames)
        {
            dbContext.GetSqlConnection().BulkMerge(data, tableName, idColumn, updateColumnNames, insertColumnNames);
        }

        public static void BulkMerge<T>(this DbContext dbContext, IEnumerable<T> data, string tableName, List<string> idColumns, string[] updateColumnNames, string[] insertColumnNames)
        {
