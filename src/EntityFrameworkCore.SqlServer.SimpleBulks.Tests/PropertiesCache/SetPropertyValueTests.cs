...
public class SetPropertyValueTests
{
    ...
    public void SetPropertyValue_Current_Level()
    {
        ...
        PropertiesCache<Order>.SetPropertyValue("Id", order, 1);
    ...
    public void SetPropertyValue_One_Level()
    {
        ...
        PropertiesCache<Order>.SetPropertyValue("ShippingAddress.Street", order, "xxx");
    ...
    public void SetPropertyValue_Two_Levels()
    {
        ...
        PropertiesCache<Order>.SetPropertyValue("ShippingAddress.Location.Lat", order, 40.7128);
